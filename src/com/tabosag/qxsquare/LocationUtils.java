...
public class LocationUtils {
	...
	public final static int UPDATE_TIME = 20000;
	/**
	 ...
	 * @return return the most recent location, or null if there's no known
	 *         location
	 */
	public static Location getLastKnownLocation(
			final LocationManager pLocationManager) {
		if (pLocationManager == null) {
			return null;
		}
		final Location gpsLocation = pLocationManager
				.getLastKnownLocation(LocationManager.GPS_PROVIDER);
		final Location networkLocation = pLocationManager
